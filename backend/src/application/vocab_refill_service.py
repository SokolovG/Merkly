...
from backend.src.domain.constants import POOL_FILL_SIZE, POOL_RECENT_HINT, POOL_THRESHOLD
from backend.src.domain.entities import UserProfile
from backend.src.domain.ports.vocab_pool_repo import IVocabPoolRepository
